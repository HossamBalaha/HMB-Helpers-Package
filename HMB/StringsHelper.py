class StringsHelper(object):
  ...
  def GetCharCountFrom(self, char, index):
    ...
    return self.__string[index:].count(char)
  ...
  def GetCharCountBetween(self, char, index1, index2):
    ...
    return self.__string[index1:index2].count(char)
  ...
  def GetCharCountBetweenInclusive(self, char, index1, index2):
    ...
    return self.__string[index1:index2 + 1].count(char)
  ...
  def GetCharCountBetweenExclusive(self, char, index1, index2):
    ...
    return self.__string[index1 + 1:index2].count(char)
  ...
  def GetPermutations(self):
    ...
    premutationsList = []
    elements = list(set(self.__string))
    for element in elements:
      restOfElements = [e for e in elements if e != element]
      for index in range(len(restOfElements)):
        currentPermutation = element + ''.join(restOfElements[index:] + restOfElements[:index])
        premutationsList.append(currentPermutation)
    return sorted(premutationsList)
  ...
  def IsPermutationOf(self, string):
    ...
    # First check:
    premutationsList = self.GetPermutations()
    check1 = string in premutationsList
    # Second check:
    check2 = sorted(string) == sorted(self.__string)
