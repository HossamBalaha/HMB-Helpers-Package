...
class TestVotingHelper(unittest.TestCase):
  ...
  def test_weighted_majority_voting_basic(self):
  ...
  def test_weighted_majority_voting_tie_breaker(self):
  ...
  def test_weighted_majority_voting_numeric_labels(self):
  ...
  def test_weighted_majority_voting_equal_weights(self):
  ...
  def test_weighted_majority_voting_single_prediction(self):
  ...
  def test_weighted_average_voting_basic(self):
  ...
  def test_weighted_average_voting_equal_weights(self):
  ...
  def test_weighted_average_voting_zero_weight(self):
  ...
  def test_weighted_average_voting_single_value(self):
  ...
  def test_weighted_median_voting_basic(self):
  ...
  def test_weighted_median_voting_skewed_weights(self):
  ...
  def test_weighted_median_voting_unsorted_input(self):
  ...
  def test_weighted_median_voting_single_value(self):
  ...
  def test_weighted_mode_voting_numeric(self):
  ...
  def test_weighted_mode_voting_labels(self):
  ...
  def test_weighted_mode_voting_single_value(self):
  ...
  def test_weighted_geometric_mean_voting_basic(self):
  ...
  def test_weighted_geometric_mean_voting_unequal_weights(self):
  ...
  def test_weighted_geometric_mean_voting_equal_values(self):
  ...
  def test_geometric_mean_voting_basic(self):
  ...
  def test_geometric_mean_voting_three_values(self):
  ...
  def test_geometric_mean_voting_equal_values(self):
  ...
  def test_weighted_harmonic_mean_voting_basic(self):
  ...
  def test_weighted_harmonic_mean_voting_unequal_weights(self):
  ...
  def test_weighted_harmonic_mean_voting_equal_values(self):
  ...
  def test_harmonic_mean_voting_basic(self):
  ...
  def test_harmonic_mean_voting_two_values(self):
  ...
  def test_harmonic_mean_voting_equal_values(self):
  ...
  def test_weighted_quadratic_mean_voting_basic(self):
  ...
  def test_weighted_quadratic_mean_voting_equal_weights(self):
  ...
  def test_weighted_quadratic_mean_voting_equal_values(self):
  ...
  def test_quadratic_mean_voting_basic(self):
  ...
  def test_quadratic_mean_voting_3_4_triangle(self):
  ...
  def test_quadratic_mean_voting_equal_values(self):
  ...
  def test_weighted_cubic_mean_voting_basic(self):
  ...
  def test_weighted_cubic_mean_voting_equal_weights(self):
  ...
  def test_weighted_cubic_mean_voting_equal_values(self):
  ...
  def test_cubic_mean_voting_basic(self):
  ...
  def test_cubic_mean_voting_two_values(self):
  ...
  def test_cubic_mean_voting_equal_values(self):
  ...
  def test_weighted_quartic_mean_voting_basic(self):
  ...
  def test_weighted_quartic_mean_voting_equal_weights(self):
  ...
  def test_weighted_quartic_mean_voting_equal_values(self):
  ...
  def test_quartic_mean_voting_basic(self):
  ...
  def test_quartic_mean_voting_two_values(self):
  ...
  def test_quartic_mean_voting_equal_values(self):
  ...
  def test_mean_relationships(self):
  ...
  def test_all_equal_values_consistency(self):
